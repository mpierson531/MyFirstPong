...
public class OnePlayerPong implements Screen {
	...
	public void render(float delta) {
		...
		shapeRenderer.rect(comPlayer.getRectangle().getX(), comPlayer.getRectangle().getY(), comPlayer.getRectangle().getWidth(), comPlayer.getRectangle().getHeight());
...
//		scoreUI.getStage().act(Gdx.graphics.getDeltaTime());
		...
		keepBallInBounds();
		checkPlayerScored();
		comPlayer.move(ball.getY());
		playerOne.onePlayerMove();
